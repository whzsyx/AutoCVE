...
```bash
curl -fsSL https://raw.githubusercontent.com/larlarua/AutoCVE/v1.0.2/docker-compose.prod.yml \
  | docker compose -f - up -d
```
Windows PowerShell / CMD :
```bash
curl.exe -fsSL https://raw.githubusercontent.com/larlarua/AutoCVE/v1.0.2/docker-compose.prod.yml | docker compose -f - up -d
```
